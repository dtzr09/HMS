...
/**
 * The PatientManager class provides utility methods for handling the
 * functionalities of a Patient.
 */
...
public class PatientManager {
     ...
     * 
     * This method returns a list of all patients in the system by fetching them
     ...
     * 
     * This method checks whether the patient database contains any patients. It
     * returns `true` if the
     ...
     * 
     * This method filters all patients by their associated doctor ID and returns a
     * list of patients
     * who are assigned to the given doctor.
     * 
     * @param doctorId the unique ID of the doctor whose patients are to be
     *                 retrieved.
     ...
     * 
     * This method fetches a patient from the `PatientDatabase` using the provided
     * patient ID.
     * If the patient is not found, an error message is printed, and the method
     * returns `null`.
     * 
     * @param patientId the unique ID of the patient to be retrieved.
     * @return the patient with the specified ID, or `null` if the patient is not
     *         found.
     */
    public static Patient getPatientById(String patientId) throws ModelNotFoundException {
     ...
     * 
     * This method adds a new allergy to the patient's list of allergies and updates
     * the patient record
