...
/**
 * The PrescriptionManager class provides utility methods for handing
 * prescriptions such as creating and updating Prescriptions.
 */
...
public class PrescriptionManager {
     ...
     * 
     * This method attempts to add a new prescription to the database. If a
     * prescription with the same ID
     ...
     * @throws ModelAlreadyExistsException If a prescription with the same ID
     ...
     * 
     * This method updates the details of an existing prescription in the database.
     * If the prescription
     * does not exist, a `ModelNotFoundException` is thrown.
     * 
     * @param newPrescription The updated `Prescription` object.
     * @throws ModelNotFoundException If the prescription to be updated does not
     ...
     * 
     * This method returns a list of all `Prescription` objects currently stored in
     ...
     * 
     * This method attempts to fetch a `Prescription` object by its ID. If the
     ...
     * @throws ModelNotFoundException If the prescription with the given ID is not
     ...
     * 
     * This method creates a new `Prescription` object using the provided details
     * and adds it to the prescription database.
     * The prescription status is set to `PENDING` by default. The prescription is
     * then stored in the database.
     * 
     * @param prescriptionID   The unique identifier for the prescription.
     * @param medicationIDs    A list of medication IDs associated with the
     *                         prescription.
     * @param drugInstructions The instructions for taking the prescribed
     *                         medications.
    ...
    /**
     * Updates the status of a prescription and handles stock reduction for
     * dispensed medications.
     * 
     * This method updates the status of a prescription identified by its ID. If the
     * new status is
     * `DISPENSED`, it reduces the stock of each medication associated with the
     * prescription by one.
     * After updating the status, the method saves the updated prescription to the
     * database.
     * 
     * @param prescriptionID The unique identifier of the prescription to be
     *                       updated.
     * @param status         The new status to set for the prescription.
     * @throws ModelNotFoundException If the prescription with the given ID cannot
