...
/**
 * The AppointmentOutcomeManager class provides utility methods for managing
 * Appointment Outcomes such as recording and retrieving.
 */
...
public class AppointmentOutcomeManager {
     ...
     * 
     * This method takes an `AppointmentOutcome` object, attempts to add it to the
     * `AppointmentOutcomeDatabase`,
     * and handles any exceptions that may arise during the process. If the outcome
     * is successfully added, it
     * remains stored in the database for future reference. If an error occurs
     * during the operation, an error
     * message is displayed.
     * 
     * @param appointmentOutcome The `AppointmentOutcome` object to be added to the
     *                           database.
     */
     ...
     * 
     * This method updates the given `AppointmentOutcome` object by setting the type
     * of service,
     * diagnosis ID, and consultation notes. The status of the appointment outcome
     * is then updated
     * to "COMPLETED". The updated outcome is stored in the
     * `AppointmentOutcomeDatabase`, and the
     * provided diagnosis is added to the `DiagnosisManager`.
     * 
     * If any error occurs during the update process, the exception is caught, and
     * an error message
     ...
     * @param typeOfService      The type of medical service provided during the
     *                           appointment.
     * @param diagnosisID        The ID of the diagnosis associated with the
     *                           appointment.
     * @param consultationNotes  Notes regarding the consultation or findings during
     *                           the appointment.
     */
     ...
     * 
     * This method fetches and returns a list of all `AppointmentOutcome` objects
     * stored in the
     * `AppointmentOutcomeDatabase`. The list contains the details of all outcomes
     * recorded for
     * appointments.
     * 
     ...
     * 
     * This method searches through all appointment outcomes in the database to find
     * the outcome
     * associated with the provided appointment ID. If the outcome is found, it is
     * returned;
     * otherwise, the method returns null.
     * 
     * @param appointmentID The ID of the appointment whose outcome is to be
     *                      retrieved.
     * @return The `AppointmentOutcome` object associated with the given appointment
     *         ID, or null
     ...
     * 
     * This method filters and returns a list of all `AppointmentOutcome` objects
     * that are associated
     * with the specified patient ID. It searches through all appointment outcomes
     * and adds those
     * matching the given patient ID to the result list.
     * 
     * @param patientID The ID of the patient whose appointment outcomes are to be
     *                  retrieved.
     * @return A list of `AppointmentOutcome` objects associated with the given
     *         patient ID,
    ...
    /**
     * Retrieves a list of appointment outcome records for a given list of
     * appointment outcomes and patient ID.
     * 
     * This method processes a list of `AppointmentOutcome` objects, fetches the
     * corresponding appointment, diagnosis,
     * and prescription details, and compiles this information into a list of
     * `AppointmentOutcomeRecord` objects. Each record
     * contains detailed information about the appointment outcome, including type
     * of service, consultation notes,
     * medication names, and prescription status.
     * 
     * @param recordList The list of `AppointmentOutcome` objects that represent the
     *                   outcomes of various appointments.
     * @param patientID  The ID of the patient whose appointment outcomes are being
     *                   processed.
     * @return A list of `AppointmentOutcomeRecord` objects, each representing the
     *         details of an appointment outcome.
     * @throws PageBackException If there is an error in fetching related data or
     *                           processing any of the outcomes.
     */
     ...
     * 
     * This method filters the list of all appointment outcomes and returns only
     * those that are associated with the given doctor ID.
     * The outcomes returned represent the results of appointments attended by the
     * specified doctor.
     * 
     * @param doctorID The ID of the doctor whose appointment outcomes are to be
     *                 retrieved.
     * @return A list of `AppointmentOutcome` objects that belong to the specified
     *         doctor.
     */
    ...
    /**
     * Retrieves the number of completed appointment outcomes for a specific
     * patient.
     * 
     * This method iterates through all appointment outcomes and counts how many are
     * associated
     * with the given patient ID and have a status of "COMPLETED".
     * 
     * @param patientID The ID of the patient whose completed appointment outcomes
     *                  are to be counted.
     * @return The number of completed appointment outcomes for the specified
     *         patient.
     */
